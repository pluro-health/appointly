declare namespace NodeJS {
  interface ProcessEnv {
    ...
    readonly NEXT_PUBLIC_APP_NAME: string | "Appointly";
    readonly NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS: string | "help@pluro.in";
    readonly NEXT_PUBLIC_COMPANY_NAME: string | "Pluro Health";
